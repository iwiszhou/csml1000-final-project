...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    mainPanel(
      ...
      p(". "),
      p <- plot_ly(
        y = c("<b>BASE OBESITY RATE</b> <br><i>(actual eating and</i> <br><i>exercise scores)</i> ", 
              "Improved Exercise <br><i>(Next decile up)</i> ", 
              "Improved Eating <br><i>(Next decile up)</i> ",
              "Improved Eating and Exercise <br><i>(Both next decile up)</i> ",
