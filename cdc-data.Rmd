...
For this final project, we will foucus on obesity rate - Q036 and Q037.
...
Maybe we can select different questions such as Q036, Q037, AND Q047 becuase they have full data from 2011-2016.
We could alos choose a single year, such as 2015 all questions have full data in year 2015.
First of all, let's choose one Question and take a look the relationship for each categories.

### Single Question Analysis - Q036 Percent of adults aged 18 years and older who have obesity

```{r message=FALSE, warning=FALSE}
q1 <- df %>% filter(QuestionID == "Q036");
...
People has lower income with higher percentage of obesity. People has higher income with lower percentage of obestity.
...
#### For "Percent of adults aged 18 years and older who have obesity" question, categories Education, Income, Age and Race/Ethnicity, which has significant impact on obesity. For example, middle aged people(35-44), who has lower education level and income less than $15,000, they will have higher chances to have a obesity health problem.
